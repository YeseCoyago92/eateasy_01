...
<html>
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            var respuesta = confirm("Esta seguro que desea eliminar este Valor?");
            if (respuesta == true) {
                return true;
            } else
            {
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            ...
                            <a class="navbar-brand" href="configuraciones.php">TIPOS IVA</a>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> LISTA DE IVAS MANEJADOS</h4>
                                    <!--boton de agregar-->
                                        ...
                                        <form action="../../../../controller/controllerAdmin.php">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_SESSION['listado_iva'])) {
                                                        $listado_iva = unserialize($_SESSION['listado_iva']);
                                                        foreach ($listado_iva as $iva) {
                                                            echo "<tr>";
                                                            echo "<td>" . $iva->getDescr_tipoiva() . "</td>";
                                                            echo "<td>" . $iva->getValor_tipoiva() . "</td>";
                                                            echo "<td>" . $iva->getEstado_tipoiva() . "</td>";
                                                            echo "<td><a href='../../../../controller/controllerAdmin.php?opcion=editar_iva&ID_TIPOIVA=" .
                                                            $iva->getId_tipoiva() . "'> Editar </a></td>";
                                                            
                                                            //echo "<td><a onclick='return ConfirmDelete()'
                                                           // style='color:red'href='../../../../controller/controllerAdmin.php?opcion=eliminar_iva&ID_TIPOIVA=" .
                                                            //$iva->getId_tipoiva() . "'> Eliminar </a></td>";
                                                            echo "</tr>";
                                                        }
                                                    } else {
