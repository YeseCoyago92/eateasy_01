                ...
                <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            ...
                            <a class="navbar-brand" href="tabla_usuarios.php">LISTA DE USUARIOS</a>
                        </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_SESSION['listado'])) {
                                                        ...
                                                        foreach ($listado as $per) {
                                                            echo "<tr>";
                                                            echo "<td>" . $per->getCedula_per() . "</td>";
                                                            echo "<td>" . $per->getNombres_per() . "</td>";
                                                            echo "<td>" . $per->getApellidos_per() . "</td>";
                                                            echo "<td>" . $per->getCorreo_per() . "</td>";
                                                            echo "<td>" . $per->getCelular_per() . "</td>";
                                                            echo "<td><a href='../controller/controller.php?opcion=editar&idFactura=" . $per->getCedula_per() . "'><span> Editar </span></a></td>";
