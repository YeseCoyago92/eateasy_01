                    ...
                    <div class="row no-gutters bg-dark">
                        ...
                        <div class="col-xl-7 col-lg-12 d-flex">
                            <div class="container align-self-center p-6">
                                <h1 class="font-weight-bold mb-3">EDITAR CATEGORÍA</h1>
            ...
            <!--                        <button class="btn btn-outline-dark d-inline-block text-light mr-2 mb-3 width-100"><i class="icon ion-logo-google lead align-middle mr-2"></i> Google </button>
                                ...
                                <form action="../../../../controller/controllerAdmin.php">
                                    <div class="form-group mb-3">
                                        <input type="hidden" name="opcion" value="actualizar_categoria">
                                    </div>

                                    <div class="form-group mb-3">
                                        <input type="hidden" class="form-control" name="ID_CATEGORIA" value="<?php echo $categoria->getId_cat(); ?>" />
                                    </div>

                                    <div class="form-group mb-3">
                                        <label class="font-weight-bold">Nombre:<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" placeholder="Nombre" name='DESCRIPCION_CATEGORIA' value="<?php echo $categoria->getDescripcion_cat(); ?>" required>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label class="font-weight-bold">Estado:<span class="text-danger">*</span></label>
                                        <select  name="ESTADO_CATEGORIA">
                                            <?php
                                            if ($categoria->getEstado_cat() == "A") {
                                                echo "<option>A</option>";
                                                echo "<option>I</option>";
                                            } else if ($categoria->getEstado_cat() == "I") {
                                                echo"<option>I</option>";
                                                echo "<option>A</option>";
                                            }
                                            ?>
