                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">MIS OFERTAS</h4>
                            </div>
...
//                                                    echo "<td>  <img src='/intranet/uploads/'".  $alim->getImagen_alimprep(). "' alt=''</td>";
                                                    echo "<td><a href='../controller/controllerAdmin.php?opcion=editar_aplimentop&ID_ALIMENTOPREPARADO=" .
                                                    $alim->getId_alimprep() . "'> Editar </a></td>";

                                                    //echo "<td><a href='../controller/controllerAdmin.php?opcion=eliminar_aplimentop&ID_ALIMENTOPREPARADO=" .
                                                    //$alim->getId_alimprep() . "'> Eliminar </a></td>";

                                                    echo "<td><a onclick='return ConfirmDelete()'style='color:red'href='../controller/controllerAdmin.php?opcion=eliminar_aplimentop&ID_ALIMENTOPREPARADO=" .
                                                    $alim->getId_alimprep() . "'> Eliminar </a></td>";
                                                    echo "</tr>";
                                                }
                                            } else {
